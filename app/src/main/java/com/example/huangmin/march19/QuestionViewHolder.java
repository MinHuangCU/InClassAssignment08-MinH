package com.example.huangmin.march19;
...
public class QuestionViewHolder extends RecyclerView.ViewHolder {
    ...
    public TextView qusetionCountry;
    ...
    public QuestionViewHolder(View itemView, final Context context){
        ...
        qusetionCountry=(TextView)itemView.findViewById(R.id.question_country);
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //Toast.makeText(context,qusetionCountry.getText(),Toast.LENGTH_SHORT).show();
                int messageId=0;
                if (isAnswerTrue){
